...
module.exports = (sequelize) => {
  class Cursos extends Model {
    static associate(models) {
      this.belongsTo(models.Categorias, { foreignKey: "categoria_id", as: 'categorias'});
      this.belongsTo(models.Usuarios, { foreignKey: "usuario_id", as: 'usuarios'});
      this.belongsTo(models.Solicitudes, { foreignKey: "solicitud_id", as: 'solicitudes'});
      this.belongsTo(models.Valoraciones, { foreignKey: "valoraciones_id", as: 'valoraciones'});
